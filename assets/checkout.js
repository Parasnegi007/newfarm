...
async function saveAddress() {
    ...
    if (token) {
        ...
        endpoint = "http://localhost:5000/api/users/addAddress";
    } else {
        ...
        endpoint = "http://localhost:5000/api/users/guest/addAddress";
    }
...
async function fetchSavedAddresses() {
    ...
    if (token) {
        endpoint = "http://localhost:5000/api/users/getAddresses";
    } else {
        ...
        endpoint = `http://localhost:5000/api/users/guest/getAddresses/${guestEmail}`;
    }
